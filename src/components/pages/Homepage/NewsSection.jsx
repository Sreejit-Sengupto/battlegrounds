  ...
  return (
    <div className="bg-homeNews bg-cover pb-16">
      ...
      <div className="flex flex-col justify-center items-center lg:flex-row w-[80%] mx-auto flex-wrap">
        <Link to={data[0].id} className="lg:w-80 my-4 lg:m-8 bg-white font-teko">
        ...
        <Link to={data[1].id} className="lg:w-80 my-4 lg:m-8 bg-white font-teko">
        ...
        <Link to={data[2].id} className="lg:w-80 my-4 lg:m-8 bg-white font-teko">
      ...
      {show && (
        <div className="flex flex-col lg:flex-row w-[80%] mx-auto flex-wrap justify-center items-center">
          <Link to={data[3].id} className="lg:w-80 my-4 lg:m-8 bg-white font-teko">
          ...
          <Link to={data[4].id} className="lg:w-80 my-4 lg:m-8 bg-white font-teko">
